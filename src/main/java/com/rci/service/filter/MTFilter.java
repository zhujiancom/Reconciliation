...
public class MTFilter extends AbstractFilter {
	...
	public boolean support(Map<String, BigDecimal> paymodeMapping) {
		return paymodeMapping.containsKey(BusinessConstant.MT_NO);
	}
...
//		if (support(order.getPaymodeMapping())) {
			...
			BigDecimal chitAmount = order.getPaymodeMapping().get(BusinessConstant.MT_NO);
			...
			schemes.putAll(createSchemes(chitAmount, BusinessConstant.MT_NO,suitFlag));
			//计算订余额
